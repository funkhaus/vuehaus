...
var update = __webpack_require__(100)("0436ab70", content, false);
...
router.beforeEach(function (to, from, next) {
    if (to.path !== from.path) {
        _store2.default.dispatch('LOAD_AND_REPLACE_QUERYDATA', to.path);
    }
    next();
});
...
// add vuex
_vue2.default.use(_vuex2.default); /* global queryData */
...
var _frontPage = __webpack_require__(104);
...
Component.options.__file = "/Users/sander/Desktop/Local Flywheel Sites/sander-moolin/app/public/wp-content/themes/vuepress/src/components/App.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
